...
export default function Movie({navigation}) {
    ...
    const apiReq = async () => {
        const respNowPlaying = await axios(`https://api.themoviedb.org/4/list/1?page=1&api_key=${apiKey}`);
  ...
  return (
    ...
    <Image
        style={{height: 150 ,width: '100%', resizeMode: 'contain', marginTop: 15}}
...
// </SkeletonPlaceholder>      
    ...
    <View>
      ...
      <Text style={{color: '#73c3f9'}}> Playing</Text>
      </Text>
      <View>
      <FlatList
      ...
      <Text style={{color: '#73c3f9'}}> Movies</Text>
      </Text>
      <FlatList
        showsHorizontalScrollIndicator={false}
        style={{marginTop: 20, marginLeft: 20}}
